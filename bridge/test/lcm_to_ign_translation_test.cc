...
TEST_F(ViewerDrawTest, TestTimeStamp) {
  translate(drawMsg, &ignPosesStamped);
  int secs = 123;
  int nsecs = 456000000;
...
TEST_F(ViewerDrawTest, TestExceptionInPosition) {
  ...
  EXPECT_THROW(translate(drawMsg, &ignPosesStamped), TranslateException);
}
...
GTEST_TEST(BoxTest, TestBoxTranslation) {
  ...
  translate(boxMsg, &ignBoxGeometry);
...
GTEST_TEST(BoxTest, TestExceptionInBoxTranslation) {
  ...
  EXPECT_THROW(translate(boxMsg, &ignBoxGeometry), TranslateException);
}
...
GTEST_TEST(CylinderTest, TestCylinderTranslation) {
  ...
  // Translate from LCM to ignition
  translate(cylinderMsg, &ignCylinderGeometry);
...
GTEST_TEST(CylinderTest, TestExceptionInCylinderTranslation) {
  ...
  EXPECT_THROW(translate(cylinderMsg, &ignCylinderGeometry),
               TranslateException);
}
...
GTEST_TEST(SphereTest, TestSphereTranslation) {
  ...
  // Translate from LCM to ignition
  translate(sphereMsg, &ignSphereGeometry);
...
GTEST_TEST(SphereTest, TestExceptionInCylinderTranslation) {
  ...
  EXPECT_THROW(translate(sphereMsg, &ignSphereGeometry), TranslateException);
}
...
GTEST_TEST(MeshTest, TestMeshTranslationWithScale) {
  ...
  // Translate from LCM to ignition
  translate(meshMsg, &ignMeshGeometry);
