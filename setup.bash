...
export DELPHYNE_PACKAGE_PATH=$BASEDIR/src/drake/drake/automotive/models:$BASEDIR/src/delphyne/bridge:$BASEDIR/src/delphyne:$BASEDIR/src/delphyne_gui:$DELPHYNE_PACKAGE_PATH
